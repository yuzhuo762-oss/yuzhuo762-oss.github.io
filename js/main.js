...
function initFilter(){
  ...
  const posterGrid=`
<a href="./works/poster-gongzhonghao.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/proj07-1.webp" alt="公众号首图" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>公众号首图</h3><p>企业微信公众号系列首图设计（6张）</p><span class="arrow">查看详情 →</span></div></a>
<a href="./works/poster-seasons.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/season_thumb.webp" alt="节气系列" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>节气系列</h3><p>二十四节气传统文化视觉设计（8张）</p><span class="arrow">查看详情 →</span></div></a>
<a href="./works/poster-qixi.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/qixi_01.webp" alt="七夕主视觉" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>七夕主视觉 &amp; 海报设计</h3><p>七夕节日KV及海报系列（10张）</p><span class="arrow">查看详情 →</span></div></a>
<a href="./works/poster-summer.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/summer_02.webp" alt="清凉一夏" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>「清凉一夏」KV设计</h3><p>夏日主题视觉设计系列（6张）</p><span class="arrow">查看详情 →</span></div></a>
<a href="./works/poster-art.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/art_thumb.webp" alt="插画设计" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>插画设计 — 穆夏风格</h3><p>穆夏风格新艺术运动插画（7张）</p><span class="arrow">查看详情 →</span></div></a>
<a href="./works/poster-daily.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/daily_thumb.webp" alt="日常海报" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>日常海报 &amp; 活动传播</h3><p>节日海报、活动通知、展会物料（11张）</p><span class="arrow">查看详情 →</span></div></a>
<a href="./works/poster-other.html" class="work-card" data-category="海报"><div class="work-card-image"><img src="./assets/images/preview/other_02.webp" alt="户外展会物料" loading="lazy"></div><div class="work-card-body"><span class="tag">海报</span><h3>户外 &amp; 展会物料</h3><p>户外广告、易拉宝、展位装饰（6张）</p><span class="arrow">查看详情 →</span></div></a>`
  ...
  btns.forEach(btn=>{btn.addEventListener("click",()=>{
    ...
    let matched=0;document.querySelectorAll(".work-card").forEach(c=>{const categories=(c.dataset.category||"").split("|");if(f==="all"||categories.includes(f)){c.style.display="";matched++}else{c.style.display="none"}})
...
function initAboutEntrance(){
  const groups=[...document.querySelectorAll('.skills-section,.about-info > div[style*="margin-top"]')];
  if(!groups.length)return;
  groups.forEach(group=>group.classList.add('about-reveal-group'));
