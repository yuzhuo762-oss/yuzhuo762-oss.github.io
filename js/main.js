...
function initLightbox(){
  ...
  document.querySelectorAll(".gallery-item,.work-card-image").forEach(item=>{item.addEventListener("click",()=>{const i=item.querySelector("img");if(!i||!i.src)return;img.src=i.src;img.alt=i.alt||"";lb.classList.add("open");document.body.style.overflow="hidden"})})
